...
Cargoup is distributed under the terms of the GNU GPL
Cargoup -Copyright 2022 Cargoup, themeansar.com
...
Cargoup is a powerful bootstrap Wordpress theme for any business. woocommerce and any other kind of website purpose. It comes with all features these kind of shop page, blog page, Contact form seven working, custom logo

===========
ABOUT THEME
=========== 
Theme has two, three, four footer layout feature.We focused on usability across various
devices, starting with smart phones.it is compatible with various devices. Cargoup is a
Cross-Browser Compatible theme that works on All leading web browsers. Cargoup is easy to use and 
user friendly theme. Cargoup has boxed and full-width layout feature.
Powerful but simple Cargoup theme content customized through customizer. to make your site attractive it has two 
widget sections first for “sidebar widget section” and second for “Footer widget section” . 

To make your website in two column use sidebar widget section. to set custom menu in header set primary location. we added social media links to added your social links.It boasts of beautifully designed page sections , Home, Blog and Default Page Template(page with right sidebar), Page Full-Width, Page Left Sidebar. Cargoup theme has more advanced feature to make your site awesome like: it has header top bar dark & lite color feature. you can also changed header color dark and lite styling. Theme compatible with woocommerce. Cargoup is a fully woocommerce tested theme. Cargoup is translation ready theme with WPML compatible & Many More….
...
Image for theme screenshot, https://pxhere.com
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1072796
